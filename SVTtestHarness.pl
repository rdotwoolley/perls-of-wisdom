...
# Here, for the testRun it will use a default of 32 users.
...
sub launchinator
	...
	# ------------------------------------------------------------
	system("ssh root\@$remoteClient '/root/rwoolley/PacsLoadTest-Albania/pacs/bin/CSI.PerformanceTest.UnitTests /root/rwoolley/PacsLoadTest-Albania/pacs/bin/test-script.xml > ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults1.txt & '");
	sleep(30);
	system("ssh root\@$remoteClient '/root/rwoolley/PacsLoadTest-Albania/pacs/bin/CSI.PerformanceTest.UnitTests /root/rwoolley/PacsLoadTest-Albania/pacs/bin/test-script.xml > ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults2.txt & '");
	sleep(60);
	system("ssh root\@$remoteClient '/root/rwoolley/PacsLoadTest-Albania/pacs/bin/CSI.PerformanceTest.UnitTests /root/rwoolley/PacsLoadTest-Albania/pacs/bin/test-script.xml > ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults3.txt & '");
	sleep(90);
	system("ssh root\@$remoteClient '/root/rwoolley/PacsLoadTest-Albania/pacs/bin/CSI.PerformanceTest.UnitTests /root/rwoolley/PacsLoadTest-Albania/pacs/bin/test-script.xml > ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults4.txt '");
	
	system("ssh root\@$remoteClient 'cat   ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults1.txt ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults2.txt ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults3.txt ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults4.txt > ~/testingResults`date +%Y-%m-%d`/$testRunName/$testRunName-numUsers-$numUsers-UxResults.txt  '");
